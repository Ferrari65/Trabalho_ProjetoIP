...
/* Renderiza a página de cadastro IP */
...
router.post('/addIP', async (req, res) => {
  ...
  try{
    ...
    const result = await pool.query(
      "INSERT INTO endereco_ip(utilizador, matricula_utilizador, ip, data_registro) VALUES ($1, $2, $3, $4)", [utilizador, matricula, ip, dataAtual]
    );
